                    ...
                    <form onSubmit={signupHandler} >
                        <div className="w-96">
                            <div className="flex flex-col mb-2">
                                ...
                                <input type="text" name='username' placeholder='Enter Name' className="border border-gray-300 px-2 py-1 rounded" required aria-required />
                            </div>
                            <div className="flex flex-col mb-2">
                            ...
                            <div className="flex flex-col mb-2">
                                ...
                                <input type="password" name='c_pass' placeholder='Confirm Password ' className="border border-gray-300 px-2 py-1 rounded" required aria-required />
                            </div>
                            <div className="flex flex-col mb-2">
                                ...
                                <input type="text" name='chapture' placeholder='Enter Captcha Above' className="placeholder:capitalize border border-gray-300 px-2 py-1 rounded" required aria-required />
                            </div>
                            {/* add profile pic */}
                            <div className="flex flex-col mb-2">
